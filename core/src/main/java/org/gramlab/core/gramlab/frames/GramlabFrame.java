		...
		tree.addMouseListener(new MouseAdapter() {
          ...
          refreshProjectMenu(project);
			...
			private JPopupMenu createFilePopup(final GramlabProject project) {
				...
				//Added by Mukarram Tailor
				List<InternalGraphEditor> grfeditors = pluginManager.getExtensions(InternalGraphEditor.class);
				
				if (grfeditors.isEmpty()) {
				...
				//Added by Mukarram Tailor
				List<InternalDictionaryEditor> diceditors = pluginManager.getExtensions(InternalDictionaryEditor.class);
				
				if (diceditors.isEmpty()) {
